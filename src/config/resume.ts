const resume = {
  ...
  contact: {
    phone: "810 771 5225",
    email: "hey@brendanfuller.com",
    github: "github.com/brendanfuller",
    location: "Michigan, USA",
    website: "brendanfuller.com",
  },
  main: {
    description: [
      "Built workflows with VueJS incorporating custom validation system known as Arc.",
      "Learned rules and conditional system tailored towards building insurance applications and services.",
      "Developed a prototyped IDE for generating the conditional rules and models that was built using React, Tailwind, Valito, and Vite.",
    ],
    subject: "Arc, React, Bootstrap, VueJS, HTML, CSS",
    company: "ArcX",
